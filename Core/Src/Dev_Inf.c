...
#endif
   "W25Q16_STM32F4xx", 	 	 // Device Name + version number
...
// Specify Size and Address of Sectors (view example below)
   0x00000200, 0x00001000,     				 // Sector Num : 32 ,Sector Size: 64 KBytes
   0x00000000, 0x00000000,
}; 

/*  								Sector coding example
	A device with successive 16 Sectors of 1KBytes, 128 Sectors of 16 KBytes,
	8 Sectors of 2KBytes and 16384 Sectors of 8KBytes
	
	0x00000010, 0x00000400,     							// 16 Sectors of 1 KBytes
	0x00000080, 0x00004000,     							// 128 Sectors of 16 KBytes
	0x00000008, 0x00000800,     							// 8 Sectors of 2 KBytes
